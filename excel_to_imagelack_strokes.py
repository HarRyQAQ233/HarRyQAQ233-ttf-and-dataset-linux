...
for z in lines:
    ...
    os.makedirs("/home/hanrufeng/datause/imagelack-strokes/28/" + str(k - 1), exist_ok=True)
    ...
    for x in range(0, k):
        ...
        cv2.imwrite("/home/hanrufeng/datause/imagelack-strokes/28/" + str(k - 1) + "/" + str(h) + "no" + str(x + 1) + ".png",
