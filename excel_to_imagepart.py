...
for z in lines:
    ...
    os.makedirs("/home/hanrufeng/datause/imagepart/28/", exist_ok=True)
    ...
    for i in range(0, nrows):
        if sheet1_content1.cell(i, 0).value == 9999:
            ...
            img1 = cv2.resize(img, (28, 28), interpolation=cv2.INTER_AREA)  # 修改图片像素长度

            cv2.imwrite("/home/hanrufeng/datause/imagepart/28/" + str(h) + '-' + str(k + 1) + '.png', img1)
